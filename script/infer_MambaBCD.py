...
def main():
    ...
    parser.add_argument('--test_dataset_path', type=str, default='/mnt/workspace/datasets/SYSU-CD/test')
    parser.add_argument('--test_data_list_path', type=str, default='/mnt/workspace/datasets/SYSU-CD/test_list.txt')
