...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model_save_path = os.path.join(args.model_param_path, args.dataset,f'319_cross_selfattention_youvss_f1f2_new_str2_ssc\{self.epoch}')
    ...
    def training(self):
        ...
        for _ in tqdm(range(elem_num)):   # tqdm：进度条
            ...
            if (itera + 1) % 40 == 0:
                ...
                #                             itera + 1) + '.png')
                #file_name = os.path.join(os.makedirs(f"/mnt/workspace/MambaCD/save/bcd/WHU-CD1/{self.epoch}ite", exist_ok=True), f"{self.epoch}_{itera + 1}.png")
                # 创建目录
                dir_path = f"/mnt/workspace/MambaCD/save/bcd/WHU-CD1/319_cross_selfattention_youvss_new_str2_ssc_{self.epoch}ite"
...
def main():
    ...
    parser.add_argument('--train_dataset_path', type=str, default='/mnt/workspace/datasets/WHU-CD1/train')
    parser.add_argument('--train_data_list_path', type=str, default='/mnt/workspace/datasets/WHU-CD1/train_list.txt')
    parser.add_argument('--val_dataset_path', type=str, default='/mnt/workspace/datasets/WHU-CD1/val')
    parser.add_argument('--val_data_list_path', type=str, default='/mnt/workspace/datasets/WHU-CD1/val_list.txt')
